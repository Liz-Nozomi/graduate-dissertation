# -*- coding: utf-8 -*-
"""
nanoparticle_gmx_potential.py
The purpose of this script is to run gmx potential but in python
...
###########################################################
### CLASS FUNCTION TO CALCULATE ELECTROSTATIC POTENTIAL ###
###########################################################
class nanoparticle_potential:
    '''
    The purpose of this function is to calculate the electrostatic potential across the box
    INPUTS:
        traj_data: [obj]
            Data taken from import_traj class
        ligand_names: [list] 
            list of ligand residue names. Note that you can list as much as you'd like, we will check with the trajectory to ensure that it is actually there.
        ...
        water_model: [str, default='TIP3P]
            water model that you are using (changes the charges that are available). Make sure to include water model charges in WATER_MODEL_CHARGES variable.
        center_of_mass_residue_name: [str, default='Au']
            center of mass that you care about. For spherical coordinates, this will be the center of reference.
        separated_ligands: [logical, default=False] 
            True if your ligands are not attached to each other -- True in the case of planar SAMs
        potential_type: [str, default='spherical']
            either 'spherical' or 'planar' potential types
        
        
    OUTPUTS:
    '''
    ### INITIALIZING
    def __init__(self, traj_data, itp_file, water_model = 'TIP3P', separated_ligands = False, potential_type = 'spherical' ):
        ### PRINTING
...
if __name__ == "__main__":
    ...
    specific_dir="EAM_310.15_K_2_nmDIAM_ROT001_CHARMM36_Trial_1" # spherical_310.15_K_2_nmDIAM_octanethiol_CHARMM36" # Directory within analysis_dir r"mdRun_363.15_6_nm_tBuOH_100_WtPercWater_spce_Pure"    
